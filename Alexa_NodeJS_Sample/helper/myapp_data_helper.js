...
function MyAppDataHelper() { }

MyAppDataHelper.prototype.requestAirportStatus = function (airportCode) {
...
MyAppDataHelper.prototype.getAirportStatus = function (airportCode) { 
    var options = {
        method: 'GET',
...
MyAppDataHelper.prototype.formatAirportStatus = function (airportStatus){
...
module.exports = MyAppDataHelper;